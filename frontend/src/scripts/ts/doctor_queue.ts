  ...
  users.forEach((user, index) => {
    ...
    const row = `<tr class="${rowClass}">
            ...
            <td>
                ...
                <button class="btn btn-secondary btn-sm pend-btn" style="background-color: yellow;" onclick="pendUser(${index})">
                    ${
                      user.status === 2
                        ? "Unpend"
                        : user.status === 3
                ...
                <button class="btn btn-success btn-sm" style="background-color: green;" onclick="completeUser(${index})">Complete</button>
            </td>
        </tr>`;
